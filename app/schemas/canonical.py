...
from app.schemas.enums import EventType, InformationClass, ZoneId, ZoneIdStr
...
class SafetyEvent(BaseModel):
    ...
    def _worker_format(cls, v: str | None) -> str | None:
        if v is not None and not re.fullmatch(r"[A-Za-z0-9][A-Za-z0-9_.\-]{0,31}", v):
            raise ValueError("worker_id must be a short alphanumeric id, e.g. 'W-003'")
        return v
