...
# Load the updated test_scenario
with open("scenarios/test_scenario.json") as f:
    data = json.load(f)
...
result = run_scenario(scenario, correlation_id="test-scenario-run")
